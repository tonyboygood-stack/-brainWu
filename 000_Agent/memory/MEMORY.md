...
- 徐浤清（失智手抖尿頻）：5/12 回診腿部大水泡，警示天皰瘡，中止針灸轉診皮膚科，待回報
- 建立天皰瘡知識卡＋自體免疫疾病 MOC
- 診所：名稱確定「**平衡木中醫診所**」；設計進度：平面圖確認中 → 建築師製圖 → 審核（共約 2-3 週）→ 同期 3D 建模
- 房東文件（所有權狀影本、身分證影本、便章、裝修同意書）＋電費單確認：5/16 晚上老吳與房東當面確認中
- 5/18（下週一）下午 4 點：顧問公司謝先生簽約
