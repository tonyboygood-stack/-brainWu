---
title: 舌診圖像對照索引（Ann Cecil-Sterman）
...
> **用途**：原圖只在本頁建立索引；判讀卡連回本頁與原書章節，而不複製或裁切。這保留了圖像、圖旁文字與原書頁碼之間的關係，也讓未來新增臨床照片時可採相同欄位。圖像是對照證據，不是獨立診斷。

## 原書內嵌圖像

| 掃描頁 | 圖像／所在脈絡 | 對應卡 |
|---|---|---|
| 1–3 | 封面與書名頁 | [[舌診（Ann Cecil-Sterman）]] |
| 6–7 | 獻詞與「舌頭是對話」的前言頁 | [[舌診的三層讀取與觀察條件（Ann Cecil-Sterman）]] |
| 41 | 滑濕、膩濕及多種舌苔質地 | [[舌苔、衛氣與津液（Ann Cecil-Sterman）]] |
...
所有檔案維持在 `600_Projects/書籍掃描/Tongue-Diagnosis-Ann-Cecil-Sterman/images/`，並由原書 Markdown 以 `![[images/page_XXX.png]]` 內嵌。若 Obsidian 已將專案根目錄設為 vault，可從下列連結直接開啟最常用的圖頁：

- [[600_Projects/書籍掃描/Tongue-Diagnosis-Ann-Cecil-Sterman/images/page_041.png|舌苔質地圖]]
...
`拍攝條件｜同意狀態｜日期／治療序列｜全舌與舌下｜舌態｜苔｜舌體｜位置｜同日脈｜病史／排泄｜病勢假說｜後續變化`

不把可辨識臉部、未經同意的照片放入知識庫；若使用患者自持照片，也需記錄它是否在相同光線／時間下拍攝。
