...
> [!warning] 會員影片目前抓不到
> cookie 沒有帶到會員身分，59 支會員專題全部被擋。重新匯出 cookie 時，請確認 Chrome 當下停在**持有會員資格的那個 Google 帳號**（多帳號登入時，匯出的是預設帳號）。覆蓋 `C:\Users\user\.config\yt-transcribe\cookies.txt` 後重跑即可，已完成的不會重做。
